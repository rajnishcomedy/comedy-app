...
import { LayoutDashboard, Library, Mic2, FileText, Zap, Lightbulb, Target, LineChart, Users, ChevronRight, ChevronLeft } from 'lucide-react';
    ...
    return (
        <nav style={{
            ...
            <div style={{ padding: "20px 16px", display: "flex", alignItems: "center", justifyContent: "space-between", borderBottom: "1px solid var(--border)", minHeight: 64 }}>
                {!collapsed && <span style={{ fontFamily: "var(--mono)", fontSize: 16, color: "var(--accent)", letterSpacing: "0.15em", textTransform: "uppercase", fontWeight: 700 }}>SetKit</span>}
                <button
                    ...
                    return (
                        ...
                        >
                            <div style={{ display: "flex", alignItems: "center", justifyContent: "center", position: "relative" }}>
                                ...
                                {isActive && collapsed && <div style={{ position: "absolute", left: -6, top: "20%", height: "60%", width: 3, background: "var(--accent)", borderRadius: 2 }} />}
                            </div>
            ...
            {!collapsed && (
                <div style={{ padding: "16px", borderTop: "1px solid var(--border)", background: "rgba(0,0,0,0.2)" }}>
                    <div style={{ fontSize: 11, fontFamily: "var(--mono)", color: "var(--text3)", lineHeight: 1.8 }}>
                        <div style={{ color: "var(--accent)", marginBottom: 4 }}>∙ Laugh trigger last</div>
                        <div>∙ Setup: straight truth</div>
